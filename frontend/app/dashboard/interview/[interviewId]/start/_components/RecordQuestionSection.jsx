...
function RecordQuestionSection({
  ...
  activeQuestionIndex,
  interviewData,
  isAnswered, // Accept isAnswered as a prop
  setIsAnswered, // Accept setIsAnswered as a prop
}) {
  ...
  const UpdateUserAnswer = async () => {
    ...
    console.log(JsonFeedbackResp.next_question);
    ...
    if (resp) {
      ...
      setUserAnswer("");
      setResults([]);
      setIsAnswered(true); // Update isAnswered to true
    }
    setResults([]);
    setLoading(false);
  };
  ...
  return (
    <>
      <div className="flex items-center justify-center flex-col">
        ...
        <Button
          disabled={loading || isAnswered} // Disable button if loading or answer is recorded
          variant="outline"
          className="my-10"
